...
|-------------- |-----------------------------------------------------|--------------|
| [**PEP Parser**](https://github.com/Michael-Burka/scrapy_parser_pep) | Tool for scraping and analyzing Python Enhancement Proposals (PEPs) from the official Python website, outputs data into CSV files. | [![Python](https://img.shields.io/badge/python-3670A0?style=flat&logo=python&logoColor=ffdd54)](https://www.python.org/) [![Scrapy](https://img.shields.io/badge/Scrapy-2.5.1-blue)](https://scrapy.org/) |
